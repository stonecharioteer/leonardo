...
class LayoutDesigner(QtGui.QWidget):
    ...
    def createUI(self):
        ...
        layout.addWidget(self.use_simple_color_replacement,1,0,1,2,QtCore.Qt.AlignLeft)
        layout.addWidget(self.background_color_threshold_label,2,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.background_color_threshold_spinbox,2,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.parent_image_position_selector,0,3,11,1,QtCore.Qt.AlignHCenter | QtCore.Qt.AlignTop)
        layout.addWidget(self.icon_positioning_label,3,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.icon_positioning_combobox,3,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.allow_overlap_checkbox,4,0,1,2,QtCore.Qt.AlignLeft)
        layout.addWidget(self.icon_bounding_box_label,5,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.icon_bounding_box_combobox,5,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.palette_selection_label,6,0,1,1,QtCore.Qt.AlignLeft)
        layout.addLayout(palette_options,6,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.background_selection_label,7,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.background_selection_combobox,7,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.primary_attr_icon_size_label,8,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.primary_attr_icon_size_spin_box,8,1,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.secondary_attr_icon_size_label,9,0,1,1,QtCore.Qt.AlignLeft)
        layout.addWidget(self.secondary_attr_icon_size_spin_box,9,1,1,1,QtCore.Qt.AlignLeft)
        #layout.addWidget(self.output_images_location_widget,7,0,1,2,QtCore.Qt.AlignLeft)
        layout.addWidget(self.validate_button,12,6,1,2,QtCore.Qt.AlignRight)
